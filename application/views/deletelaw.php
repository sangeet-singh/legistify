...
<head>
    ...
    <title>Dashboard - Delete Lawyer</title>
...
<body>
        ...
        <div id="page-wrapper">
        	<div class="row">
				...
				<h1 class="center">Lawyer Deleted Successfully.</h1>
				<?php } elseif($message=="failure"){?>
				<h1 class="center">No such record found.</h1>
				<?php } else{?>
				<h1 class="center">Delete a Lawyer</h1>
				<form action=<?php echo base_url()."deletelaw";?> class="login-form" method="post">
                        <fieldset>
