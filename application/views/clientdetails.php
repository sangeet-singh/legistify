...
<head>
    ...
    <title>Dashboard - Update Details</title>
...
<body>
        ...
        <div id="page-wrapper">
        	<div class="row">
                ...
                <?php }?>
				<form action=<?php echo base_url()."client/update";?> class="login-form" method="post">
                        <fieldset>
                            ...
                            <section class="row low-padding">
                                <label class="col col-lg-5 control-label label-text" for="name">Username</label>
                                <div class="controls">
                                    <input name="username" placeholder="John" value="<?php echo $username ?>" type="text" maxlength="20" id="uname" class="col col-lg-3" required/>
                                </div>
                            </section>
                            <section class="row low-padding">
                                <label class="col col-lg-5 control-label label-text" for="first-name">Email Id</label>
                                <div class="controls">
                                    <input name="email_id" placeholder="someone@domain.com" value="<?php echo $email_id ?>" type="text" maxlength="20" id="uname" class="col col-lg-3" required/>
                                </div>
                            </section>
                        </fieldset>
...
<div id="container">
	<h1>Change details</h1>
	<form action="update" method="post" >
		Name: <input type="text" name="name" value="<?php echo $prof_name ?>"><br>
		Email: <input type="text" name="email" value="<?php echo $email ?>"><br>
		Phone: <input type="text" name="phone" value="<?php echo $phone ?>"><br>
	<input type="submit">
</div>
