...
<head>
    ...
    <title>Dashboard - Delete Admin</title>
...
<body>
        ...
        <div id="page-wrapper">
        	<div class="row">
				...
				<?php if($success==1){?>
				<h1 class="center">Admin Deleted Successfully.</h1>
                <h2 class="center"><a href=<?php echo base_url()."deleteadmin"?>>Delete Another Admin</a></h2>
				<?php } elseif($success==0){?>
				<h1 class="center">No such record found.</h1>
				<?php } elseif($success==-1){?>
                <h1 class="center">You cannot delte yourself :p</h1>
                <h2 class="center"><a href=<?php echo base_url()."deleteadmin"?>>Delete Any Other Admin</a></h2>
                <?php } else{?>
				<h1 class="center">Delete an Admin</h1>
				<form action=<?php echo base_url()."deleteadmin"?> class="login-form" method="post">
                        <fieldset>
                            <section class="row low-padding">
                                <label class="col col-lg-5 control-label label-text" for="uname">Username</label>
                                <div class="controls">
                                    <input name="username" placeholder="John" type="text" maxlength="40" id="username" class="col col-lg-3" required/>
                                </div>
                            </section>
                        </fieldset>
                        <button class="btn btn-primary form-element no-margin-top">Delete</button>
                </form>
                <?php }?>
			</div>
		</div>
